            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <div className="flex justify-center items-center mb-4">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800">Upcoming Campus Events</h2>
                    </div>
                </div>
                    ...
                    <div className="relative">
                        ...
                        {events.map((event, index) => (
                            <div key={index} className="relative flex items-start space-x-6 pb-10">
                                ...
                                <div className="flex-1 bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 flex justify-between items-center">
                                    <div>
